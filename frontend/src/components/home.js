...
import pic_bg from "../images/pic-bg.svg";
import prog_bg from "../images/prog-bg.svg";
    ...
    return (
        <section className="home">
            ...
            <div className="rightSection">
                <img alt="svg" src={pic_bg} className="svg-bg" />
                <img alt="dev" src={dev} className="dev" />

                <img alt="svg" src={prog_bg} className="prog-bgPY" />
                <svg className="PY" viewBox="0 0 128 128">
                    <path
                        fill="#149414"
                ...
                <img alt="svg" src={prog_bg} className="prog-bgJS" />
                ...
                <img alt="svg" src={prog_bg} className="prog-bgSHPY" />
                <svg className="SHPY" viewBox="0 0 128 128">
                    <g fill="#149414">
